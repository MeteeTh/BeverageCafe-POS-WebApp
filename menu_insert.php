...
if ((isset ($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf(
    "INSERT INTO menulist (menu_id, menu_name, menu_price, menu_cost, type_id) VALUES (%s, %s, %s, %s, %s)",
    ...
    <table align="center">
      <tr valign="baseline">
        <td width="388" colspan="3" nowrap="nowrap" class="text-kanitx">
          ...
          <p>รหัสเมนู<font color="red">*</font>
          </p>
          <p>
            <input name="menu_id" type="text" disabled="disabled" class="text-kanit form-control"
              value="<?php echo $new_num; ?>" readonly="readonly" style="width: 100%;" />
          </p>
        </td>
      </tr>
      <tr valign="baseline">
        <td colspan="3" nowrap="nowrap" class="text-kanitx">
          <p>ชื่อเมนู<font color="red">*</font>
          </p>
          <p>
            <input name="menu_name" type="text" class="text-kanit form-control " placeholder="ป้อนชื่อเมนู" value=""
              style="width: 100%;" />
          </p>
        </td>
      </tr>
      ...
      <tr valign="baseline">
        <td colspan="3" nowrap="nowrap" class="text-kanitx">
          <p>ประเภทเมนู<font color="red">*</font>
          </p>
          <p>
            <select name="type_id" class="text-kanit form-select" style="width: 100%;">
              ...
              do {
                ?>
                <option value="<?php echo $row_Rec_type['type_id'] ?>">
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" class="text-kanitx">
          <p>ราคา<font color="red">*</font></p>
        </td>
        <td nowrap="nowrap" class="text-kanitx"><span class="text-kanitx">฿</span> <input name="menu_price"
            type="number" step="0.01" class="text-kanit form-control2 " placeholder="ป้อนราคาขายต่อหน่วย" size="32" />
        </td>
        <td nowrap="nowrap" class="text-kanitx">&nbsp;ต้นทุน<font color="red">*</font><span
            class="text-kanitx">฿</span><span class="text-warning">
            <input name="menu_cost" type="number" step="0.01" class="text-kanit form-control2"
               placeholder="ป้อนราคาต้นทุนต่อหน่วย" value="" size="32" /></span>
        </td>
      </tr>
      <tr valign="baseline">
