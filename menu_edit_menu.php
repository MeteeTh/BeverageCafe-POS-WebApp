...
<body>
  ...
  <table width="80%" border="0" align="center" cellpadding="5" cellspacing="5" style="vertical-align: middle;">
      ...
      <td colspan="3" align="center" class="text-kanit"> <h3><strong>จัดการรายการเมนู</strong></h3>
    ...
    <tr align="right">
      ...
      <td width="61%" class="text-kanit">
        ...
        <form action="" method="get">
          <p>
            <input name="search" type="text" placeholder="ป้อนชื่อเมนู" size="25" style="height:40px; font-size: 20px;"
              class="form-control2" autofocus />
      ...
      <td align="left" class="text-kanit">
        <p><a href="menu_insert.php" class="add-new-button ex2"
            style="height: 40px; width: 150px; letter-spacing: 2px; font-size: 20px;">เพิ่มเมนู&nbsp;<i
    ...
    <tr>
      <td colspan="3" align="center" class="text-kanit">
        <h5>ผลการค้นหาพบ
          <?php echo $totalRows_Rec_menulist ?> รายการ
        </h5>
        <p></p>
        <div style="height: 65vh; overflow-y: scroll; ">
          <table border="0" align="center" cellpadding="5" cellspacing="5"
            ...
            <tr>
              <td width="13%" height="54" align="center"><strong>รหัสเมนู</strong></td>
              <td width="26%" align="center"><strong>ชื่อเมนู</strong></td>
              <td width="18%" align="center"><strong>ประเภท</strong></td>
              <td width="14%" align="right"><strong>ราคาขายต่อหน่วย</strong></td>
              <td width="14%" align="right"><strong>ราคาต้นทุนต่อหน่วย</strong></td>
              <td width="7%" align="center"><strong>แก้ไข</strong></td>
              <td width="8%" align="center"><strong>ลบ</strong></td>
            </tr>
            <?php
            if (mysql_num_rows($Rec_menulist) > 0) {
              ?>
              <?php do { ?>
                <tr>
                  <td align="center">
                    <p>
                      <?php echo $row_Rec_menulist['menu_id']; ?>
                    </p>
                  </td>
                  <td align="left">
                    <p>
                  ...
                  <td align="left">
                    <p>
                      ...
                      <?php echo $row_Rec_menulist['type_name']; ?>
                    </p>
                  </td>
                  <td align="right">
                    <p>฿
                  ...
                  <td align="right">
                    <p>฿
                      <?php echo $row_Rec_menulist['menu_cost']; ?>
                    </p>
                  </td>
                  <td align="center">
                    <p><a href="menu_edit.php?mid=<?php echo $row_Rec_menulist['menu_id']; ?>" class="edit-button ex3"
                        style="letter-spacing: 1px; font-size: 18px;"><i class="fa-solid fa-pen"></i></a></p>
                  </td>

                  <td align="center">
                    <p><a href="#" class="delete-button ex4" style="letter-spacing: 1px; font-size: 18px;"
                        data-bs-toggle="modal" data-bs-target="#confirmDeleteModal"
                        data-name="<?php echo $row_Rec_menulist['menu_name']; ?>"
                        data-id="<?php echo $row_Rec_menulist['menu_id']; ?>"><i class="fa-solid fa-trash-can"></i></a></p>
                  </td>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title fs-5" id="confirmDeleteModalLabel">Confirm Delete</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body" style="font-size: 20px;">
                          คุณต้องการลบเมนู <span id="menuNameToDelete"></span> ใช่หรือไม่ ?
                        </div>
                  ...
                  <script>
                    $(document).ready(function () {
                      $('.delete-button').click(function () {
                        ...
                        $('#confirmDeleteButton').attr('href', 'menu_delete.php?mid=' + menuId);
                      });
                    });
                  </script>
